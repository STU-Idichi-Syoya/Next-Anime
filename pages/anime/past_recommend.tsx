...
import { getNowSeson, rangeSeson } from '../../util/str';
...
const gql=`
{
  searchWorks(seasons:[${rangeSeson(1960,new Date().getFullYear())}],first:40, orderBy: {field: WATCHERS_COUNT, direction: DESC}) {
    nodes {
      title
      malAnimeId
      image {
